...
- مكتبة ملصقات أداء تضم 100 ملصق تقريبًا.
- الإدارة تختار ملصقًا لكل ورد، أو يُقترح ملصق تلقائي حسب تقييم الأداء.
- الطالب يرى الملصق كبيرًا في نتيجة اليوم، ويراه بجانب كل ورد في سجل الحفظ.
- عند إضافة طالب جديد يتم إنشاء خطة خاصة مستقلة له، ولا تُنسخ خطة ريم أو عائشة.
- يمكن تحديد اسم خطة الطالب الجديد ونطاق السور وتواريخ البداية والنهاية من نموذج الإضافة.
...
- الإدارة فقط تستطيع اختيار ملصق الورد.
...
- `supabase/migrations/20260608_assignment_stickers.sql`: إضافة حقول ملصقات الورد.
